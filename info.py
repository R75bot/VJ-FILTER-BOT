...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002104411252').split()]
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+eNlsg-UF6P4xN2M1')
